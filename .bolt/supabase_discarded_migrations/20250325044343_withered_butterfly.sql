/*
  ...
  1. Core Tables
    - users
    - exercises
    - meals and alternatives
    - metrics and weight records
    - user activities (exercises, meals)
...
CREATE INDEX IF NOT EXISTS weight_records_user_id_date_idx ON weight_records(user_id, date);
CREATE INDEX IF NOT EXISTS user_exercises_user_id_idx ON user_exercises(user_id);
CREATE INDEX IF NOT EXISTS user_meals_user_id_idx ON user_meals(user_id);
...
CREATE INDEX IF NOT EXISTS meal_alternatives_original_meal_id_idx ON meal_alternatives(original_meal_id);
CREATE INDEX IF NOT EXISTS notifications_recipient_id_idx ON notifications(recipient_id);
CREATE INDEX IF NOT EXISTS chat_messages_user_idx ON chat_messages(sender_id, recipient_id);